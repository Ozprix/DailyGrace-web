...
import { ArrowLeft, ArrowRight, Bookmark, BookOpen, CalendarDays, CheckCircle, Edit3, Hourglass, Info, Loader2, Lock, MessageCircle, PlayCircle, Send, ShieldCheck, Sparkles, Target, Terminal, HeartHandshake } from 'lucide-react';
